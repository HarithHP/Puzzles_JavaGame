...
public class DecodeHuffman extends javax.swing.JFrame {

    /**
     * Creates new form DecodeHuffman
     */
    int uid;
    String uname;
    ...
    public DecodeHuffman(int uid, String uname) {
        this.uname = uname;
        this.uid = uid;
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_userName1.setText("Decode Puzzle");
        ...
        btn_generateWord.setText("Generate Encoded Word");
        ...
        jScrollPane3.setViewportView(txt_userAnswer);

        btn_submit1.setBackground(new java.awt.Color(204, 255, 255));
        btn_submit1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btn_submit1.setForeground(new java.awt.Color(12, 19, 79));
        ...
        lbl_instruction2.setText("Generate a Encoded word and Decode it.");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(btn_submit1, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecodeHuffman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DecodeHuffman(1, "UserName").setVisible(true);
            }
        });
    }
